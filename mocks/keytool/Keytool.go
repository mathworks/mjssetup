...
// GenerateMetricsCertificatesAndKeys provides a mock function with given fields: _a0
func (_m *Keytool) GenerateMetricsCertificatesAndKeys(_a0 *keytool.GenerateMetricsCertificatesAndKeysInputs) error {
	ret := _m.Called(_a0)
...
//   - _a0 *keytool.GenerateMetricsCertificatesAndKeysInputs
func (_e *Keytool_Expecter) GenerateMetricsCertificatesAndKeys(_a0 interface{}) *Keytool_GenerateMetricsCertificatesAndKeys_Call {
	return &Keytool_GenerateMetricsCertificatesAndKeys_Call{Call: _e.mock.On("GenerateMetricsCertificatesAndKeys", _a0)}
}

func (_c *Keytool_GenerateMetricsCertificatesAndKeys_Call) Run(run func(_a0 *keytool.GenerateMetricsCertificatesAndKeysInputs)) *Keytool_GenerateMetricsCertificatesAndKeys_Call {
	_c.Call.Run(func(args mock.Arguments) {
