...
func parseCreateSharedSecretInputs(args []string, flags *flag.FlagSet) (*keytool.CreateSharedSecretInputs, error) {
...
func parseGenerateCertificateInputs(args []string, flags *flag.FlagSet) (*keytool.GenerateCertificateInputs, error) {
...
func parseCreateProfileInputs(args []string, flags *flag.FlagSet) (*keytool.CreateProfileInputs, error) {
